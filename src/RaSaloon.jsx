    ...
    >
      ...
      <section
        ...
        style={{
          ...
          overflow: "hidden",
          background:
            "radial-gradient(ellipse at 60% 40%, #1a1200 0%, #0a0a0a 60%)",
        }}
      >
        {/* Decorative rings */}
        ...
        >
          ...
          >
            <span className="gold-text">RA</span>
            <br />
            <span
              style={{
                color: "#f0e8d8",
          ...
          {[
            {
              icon: "💈",
              title: "Unisex Salon",
              desc: "Services for Men, Women & Kids",
            },
            {
              icon: "🌿",
              title: "Premium Products",
              desc: "Top branded, skin-safe products",
            },
            {
              icon: "🕐",
              title: "Open Daily",
              desc: "9 AM – 9 PM, 7 days a week",
            },
            {
              icon: "📍",
              title: "Gachibowli",
              desc: "Easily accessible location",
            },
          ].map(({ icon, title, desc }) => (
            <div
              key={title}
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ fontSize: "0.8rem", color: "rgba(240,232,216,0.6)" }}
                >
                  {desc}
                </div>
              </div>
      ...
      <section
        id="services"
        style={{ padding: "100px 5%", background: "#0a0a0a" }}
      >
        <AnimSection>
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            ...
            <h2
              ...
              style={{ fontSize: "2.8rem", fontWeight: "normal" }}
            >
              Our Services
            </h2>
          </div>
      ...
      <section
        id="pricing"
        style={{ padding: "80px 5%", background: "#0d0d0d" }}
      >
        <AnimSection>
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            <div
      ...
      <section
        id="gallery"
        style={{ padding: "80px 5%", background: "#0a0a0a" }}
      >
        <AnimSection>
              ...
              {[
                {
                  ...
                  title: "Address",
                  detail:
                    "RA Unisex Saloon, Gachibowli, Hyderabad, Telangana – 500032",
                },
                { icon: "📞", title: "Phone", detail: "+91 98765 43210" },
                {
                  icon: "✉️",
                  title: "Email",
                  detail: "raunisexsaloon@gmail.com",
                },
                {
                  icon: "🕐",
                  title: "Hours",
                ...
                },
                {
                  icon: "📍",
                  title: "Nearby",
                  detail: "Near DLF Cyber City, Gachibowli Metro",
                },
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      padding: "16px 20px",
                      borderRight:
                        i < 2 ? "1px solid rgba(201,168,76,0.1)" : "none",
                      display: "flex",
                      gap: "10px",
                      alignItems: "center",
                    }}
      ...
      >
        ...
        >
          {navLinks.map((l) => (
            <button
              ...
              onMouseLeave={(e) =>
                (e.target.style.color = "rgba(240,232,216,0.4)")
              }
            >
              {l}
            </button>
        ...
        >
          © 2026 RA Unisex Saloon. All rights reserved. ✦ Made with ❤️ in
          Gachibowli ✦ Digital Partner: KrinSys
        </div>
      </footer>
    </div>
  );
